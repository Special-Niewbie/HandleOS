...
{
    internal class GPUINTELSDILowLatencyCheck
    {
        public static void CheckLowLatency(ControlToggles controliNTELgpuSDI, MessagesBoxImplementation messagesBoxImplementation)
        {
            try
            {
                ...
                {
                    controliNTELgpuSDI.IsOn = foundMSISupported;
                });
            }
            catch (Exception ex)
            {
