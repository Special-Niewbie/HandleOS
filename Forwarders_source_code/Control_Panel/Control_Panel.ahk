...
FileInstall, Control_PanelX_icon56x56.png, %A_Temp%\Control_PanelX_icon56x56.png, 1

Menu, Tray, NoStandard
Menu, Tray, Tip, Control Panel
Menu, Tray, Add, Restart Control Panel, ReloadScript
...
Gui, Color, 0x647995 ; Background Black Color
Gui, Add, Picture, x0 y0 w%ImageWidth% h%ImageHeight% vMyIcon gMyIconClick, %A_Temp%\Control_PanelX_icon56x56.png
WinSet, TransColor, 0x647995
Gui, Show, NA x%PosX% y%PosY%, Control Panel
