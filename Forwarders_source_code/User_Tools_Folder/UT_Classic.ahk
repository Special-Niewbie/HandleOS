...
; Combine the Desktop path with the "Tools" folder name
folderPath := desktopPath "\Tools"

; FileInstall to include the image in the project
FileInstall, UTClassic56x56.png, %A_Temp%\UTClassic56x56.png, 1

Menu, Tray, NoStandard
Menu, Tray, Tip, User Tools Explorer
Menu, Tray, Add, Restart User Tools Explorer, ReloadScript
...
Gui, Color, 0x0E43BC  ; Background Black Color
Gui, Add, Picture, x0 y0 w%ImageWidth% h%ImageHeight% vMyIcon gMyIconClick, %A_Temp%\UTClassic56x56.png
WinSet, TransColor, 0x0E43BC
Gui, Show, NA x%PosX% y%PosY%, User Tools Explorer
